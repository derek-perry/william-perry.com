  ...
  return (
    <footer className='border-t border-wpRed bg-wpWhite text-wpBlack text-xl w-full'>
      <div className='pt-16 pb-12 px-9 flex flex-col gap-y-10 text-center items-center justify-center'>
        <div className='flex flex-row flex-wrap gap-x-[66px] gap-y-7 text-center items-center justify-center'>
        ...
        <div className='flex flex-row flex-wrap gap-x-[575px] gap-y-4 text-center items-center justify-center'>
